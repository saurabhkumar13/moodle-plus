...
/*
	Extends class identicon to make symmetric identicon
 */
...
public class SymmetricIdenticon extends Identicon {
	...
	protected int getIconColor() {
		return Color.parseColor(colorsHex2[(input-1)%colorsHex2.length]);
	}
